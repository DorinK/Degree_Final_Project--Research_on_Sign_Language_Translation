...
def find_correspondence_asl_bsl(asl_dataset="wlasl", bsl_pkl="misc/bsl1k/bsl1k_vocab.pkl"):
    ...
    print(f"Finding correspondence between {asl_dataset} ASL and {bsl_pkl} BSL")
    words_asl = pkl.load(open(os.path.join("data", asl_dataset, "info/info.pkl"), "rb"))["words"]
...
def init_cross_language(init_str, model, pretrained_w, pretrained_b, asl_dataset, bsl_pkl):
